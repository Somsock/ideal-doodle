...
public class ProductionCost {
     ...
     public static void run(){
         ...
         String prompt = "How many books will you order?";
         one.setQuantity(getValidInt(prompt));
         prompt = "According to your printer, how much will it cost to produce this many books?";
         one.setCost(getValidDouble(prompt));
         prompt = "How much will you be selling the book for?";
         Book book = new Book(getValidDouble(prompt));
         one.setBook(book);
     ...
     //need to account for cancel button
